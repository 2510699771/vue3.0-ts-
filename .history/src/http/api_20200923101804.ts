...
export default {
    ...
    hotels({ id, city, price_in, scenic, name_contains,hotellevel,hoteltype,hotelbrand,hotelasset,enterTime,person,_sort,_limit,_start}:{
        id?: number, city: number, price_in?: number, scenic?: number, name_contains?: string, hotellevel?: number, hoteltype?: number, hotelbrand?: number, hotelasset?: number, enterTime?: Date, person?: number, _sort?:
    }),
    options() {
