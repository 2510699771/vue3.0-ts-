...
export default {
    ...
    //登录
    login({ username, nickname, captcha, password }: { username: string | number, nickname: string, captcha: String, password: string }) {
        return service.post(`accounts/login`, { username, nickname, captcha, password })
    },
}