  ...
  <div class="strategyall">
    <div class="strategy">
      <div style="width:70%;border:1px solid red">
        ...
        <h1
          style="border:1px solid grayheight:80px;width:100%;border:1px solid red;display:flex;justify-content:center; align-items: center;font-size:30px;font-weight: bolder;"
        >{{info.title}}</h1>
      </div>
      <div></div>
    </div>
