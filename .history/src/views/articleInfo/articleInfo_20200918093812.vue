    ...
    <div class="strategy">
      <div style="width:70%">
        ...
        <div>
          ...
          />
          <div class="comments">
            <div v-for="(item,index) in comments" :key="index" class="for">
              <div style="display:flex;margin-left:20px">
                ...
                <div style="font-size:15px;font-weight: bolder;">{{item.account}}</div>
                <div>{{item.created_at}}</div>
              </div>
              <div style="font-size:17px;margin-left:25px;;margin-left:25px">{{item.content}}</div>
            </div>
          </div>
        </div>
      </div>
