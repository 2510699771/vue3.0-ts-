...
.html /deep/ p:nth-of-type(1) {
  text-indent: 2em;
}
.html /deep/ p:nth-of-type(3) {
  text-indent: 2em;
}
.html /deep/ p:nth-of-type(5) {
  text-indent: 2em;
}
.html /deep/ p:nth-of-type(9) {
  text-indent: 2em;
}
.html /deep/ p:nth-of-type(10) {
  text-indent: 2em;
}
.html /deep/ p:nth-of-type(11) {
  text-indent: 2em;
}
</style>