<template>
  <div class="strategyall">
    <div class="strategy">
      <div style="width:65%;border">
        <div>
          <a-page-header style="margin:0" :breadcrumb="{ routes }" />
        </div>
        <div
          style="width:100%;border:1px solid red;display:flex;justify-content:center; align-items: center;font-size:28px;font-weight: bolder;"
        >{{info.title}}</div>
      </div>
      <div></div>
    </div>
