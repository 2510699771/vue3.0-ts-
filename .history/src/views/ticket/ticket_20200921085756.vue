    ...
    <div class="strategy">
      <div class="leftall">
        <div style="width:100%;margin-top:15px" class="topleft">
          ...
          <div style="display:flex">
            <!-- 起飞机场 -->
            <a-select placeholder="起飞机场" style="width: 120px;margin-right:15px" ref="select" @change="handleChange">
              <a-select-option v-for="(item,index) in airport" :key="index" :value="item">{{item}}</a-select-option>
            </a-select>
            <!-- 起飞时间 -->
            <a-select placeholder="起飞时间" style="width: 120px;margin-right:15px" ref="select" @change="handleChange">
              <a-select-option
            ...
            <!-- 航空公司 -->
            <a-select placeholder="航空公司" style="width: 120px;margin-right:15px" ref="select" @change="handleChange">
