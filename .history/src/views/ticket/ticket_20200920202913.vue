            ...
            <div class="ticket">
              ...
              <div class="ticketInfo">
                <div v-for="(ite,ind) in item.seat_infos" :key="ind" class="soloticketInfo">
                  <div style="display:flex;width:55%;border:1px solid red">
                    <div style="color:">{{ite.group_name}}|</div>
                    <div>{{ite.supplierName}}</div>
                  </div>
                  <div>￥{{ite.settle_price}}</div>
                  <div
                    style="width:10%;border:1px solid red;  align-items: center;justify-content: center;flex-direction: column;"
                  >
                    <div>
                      <button>选定</button>
                    </div>
