        ...
        <div class="for" style="margin-top:7px">
          ...
          >
            <div class="info" style="margin-top:7px">
              ...
              <div style="display:flex;align-items:center;height:35px;border:1px solid red">
                <span style="display:flex;align-items:center;height:100%">￥</span>
                <span style="color: orange;font-size: 24px;">{{item.base_price/2}}</span>
                <span style="display:flex;align-items:center;height:100%">起</span>
              </div>
            </div>
            <div class="ticket">
              <div style="margin-left:2%">低价推荐</div>
              <div class="ticketInfo">
                <div v-for="(ite,ind) in item.seat_infos" :key="ind" class="soloticketInfo">
                  <div style="display:flex;width:55%;font-size: 12px">
                    <div style="color:green">{{ite.group_name}}</div>
                    <div style="margin:0 5px">|</div>
                    <div>{{ite.supplierName}}</div>
                  </div>
                  <div>￥{{ite.settle_price}}</div>
                  <div
                    style="width:10%;align-items: center;justify-content: center;flex-direction: column;"
                  >
                    <div>
                      <button>选定</button>
                    </div>
