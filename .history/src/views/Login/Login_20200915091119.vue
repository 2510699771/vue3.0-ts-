<template>
  <div class="loginbcg">
    <a-form ref="ruleForm" :model="ruleForm" :rules="rules" :wrapper-col="wrapperCol">
...
<script lang='ts'>
import { defineComponent, toRefs, SetupContext, reactive, toRaw } from "vue";
