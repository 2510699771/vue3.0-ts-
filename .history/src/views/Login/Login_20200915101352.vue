<template>
  <div class="loginbcg">
    <div class="login">
      <a-tabs @change="callback" s>
        <a-tab-pane key="1" tab="登录" style="width:50%">
          <a-form
            ref="Form"
            :model="form"
            :rules="rules"
            ...
            style="border:1px solid red;margin-bottom: 0"
          >
            <a-form-item>
        ...
        <a-tab-pane key="2" tab="注册" force-render>Content of Tab Pane 2</a-tab-pane>
      </a-tabs>
    </div>
  </div>
</template>
