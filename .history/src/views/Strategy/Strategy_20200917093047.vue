  ...
  <div class="strategyall">
    <div class="strategy">
      ...
      <div class="right">
        ...
        <!-- 推荐攻略-->
        <div
          style="width:100%;display:flex;align-items:center;justify-content:space-between;border:1px solid red"
        >
          <div
            style="color:orange;font-size:20px;height:55px;display:flex;align-items:center;justify-content:center;border-bottom:3px solid orange;"
          >推荐攻略</div>
          <div>
