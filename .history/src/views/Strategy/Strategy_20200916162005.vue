        ...
        <div v-for="(item,index) in citys" :key="index" class="leftbox">
          <div class="leftcity">
            ...
            <div class="cityinfo" v-if="index===1">
              <div style="width:95%">
                <div v-for="(ite,ind) in item.children" :key="ind" class="citychildren" @focus="getfcus(item)">
                  <div style="font-size:28px;color:orange">{{ind+1}}</div>
                  <div
                    style="color: orange;margin-left:15px;word-wrap:nowrap"
                  >{{ite.city}}</div>
