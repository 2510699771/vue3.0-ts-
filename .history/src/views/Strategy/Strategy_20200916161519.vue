            ...
            <div class="cityinfo" v-if="index===1">
              <div style="width:95%">
                <div v-for="(ite,ind) in item.children" :key="ind" class="citychildren">
                  ...
                  <div style="color: orange;margin-left:15px;word-wrap:nowrap" class="city">{{ite.city}}</div>
                  <div style="margin-left:15px;word-wrap:nowrap">{{ite.desc}}sddddddddddddddddddddd</div>
                </div>
              </div>
            </div>
          </div>
