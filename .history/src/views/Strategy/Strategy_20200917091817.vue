  ...
  <div class="strategyall">
    <div class="strategy">
      ...
      <div class="right">
        ...
        <!-- 推荐城市 -->
        <div style="width:20%;border:1px solid red;display:flex;margin-top:15px ">
          <div>推荐:</div>
          <div style="margin-left:10px;cursor:pointer" class="type">广州</div>
          <div style="margin-left:10px;cursor:pointer" class="type">上海</div>
          <div style="margin-left:10px;cursor:pointer" class="type">北京</div>
        </div>
      </div>
    </div>
  </div>
