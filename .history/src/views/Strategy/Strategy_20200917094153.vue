    ...
    <div class="strategy">
      ...
      <div class="right">
        ...
        <div style="width:100%;display:flex;align-items:center;justify-content:;">
          <div
            style="width:15%;color:orange;font-size:20px;height:55px;display:flex;align-items:center;justify-content:center;border-bottom:1.5px solid orange;"
          >推荐攻略</div>
          <div
            style="height:55px;border-bottom:1px solid rgb(184, 180, 180);width:85%;display:flex;align-items:center;justify-content:flex-end;"
          >
