            ...
            <div class="cityinfo" v-show="num===index" @mouseenter="getfcus(item,index)">
              <div style="width:95%">
                <div v-for="(ite,ind) in item.children" :key="ind" class="citychildren">
                  <div style="font-size:25px;color:orange;cursor:pointer">{{ind+1}}</div>
                  <div style="color: orange;margin-left:15px;word-wrap:nowrap;cursor:pointer">{{ite.city}}</div>
                  <div style="margin-left:15px;word-wrap:nowrap;color: gray;cursor:pointer">{{ite.desc}}</div>
                </div>
              </div>
            </div>
          </div>
