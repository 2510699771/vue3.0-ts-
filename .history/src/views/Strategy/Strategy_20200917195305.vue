    ...
    <div class="strategy">
      ...
      <div class="right">
        ...
        >
          ...
          >{{item.summary}}</div>
          <div v-if="item.images.length>0" style="display:flex;width:100%;flex-wrap:wrap;justify-content: space-between;">
            <div v-for="(ite,ind) in item.images" :key="ind" style="width:30%;display:flex;">
                <img :src="`${ite}`" style="width:100%;height:200px;object-fit:cover;" />
            </div>
          </div>
          <!-- 地点，作者，观看次数，点赞次数 -->
