      ...
      <div class="right">
        ...
        >
          ...
          <div style="display:flex;justify-content:space-between;">
            ...
            <div style="display:flex;margin:20px 0 10px 0" v-if="item.like">{{item.like}}赞</div>
            <div style="display:flex;margin:20px 0 10px 0；font-size:20px;color:orange" v-else>0赞</div>
          </div>
        </div>
      </div>
    </div>
