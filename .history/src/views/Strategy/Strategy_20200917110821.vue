    ...
    <div class="strategy">
      ...
      <div class="right">
        ...
        <div v-for="(item,index) in article" :key="index">
          ...
          <div
            v-if="item.images"
            style="display:flex;width:100%;flex-wrap: wrap;border:1px solid red"
          >
            <div v-for="(ite,ind) in item.images" :key="ind" style="width:30%;">
              <img
                :src="`${ite}`"
                v-if="ind%3===0 || ind===0 "
                style="width:100%;height:200px;object-fit:cover;border:1px solid red"
              />
              <img
                :src="`${ite}`"
                v-else
                style="width:100%;height:200px;object-fit:cover;margin-left:20px;border:1px solid yellow"
              />
            </div>
          </div>
        </div>
