<template>
  <div class="strategyall">
    <div class="strategy">
      <div class="left">
        <div v-for="(item,index) in citys" :key="index" class="leftbox" @mouseenter="getfcus(item)">
          <div class="leftcity">
            <div>{{item.type}}</div>
            <div>
              <RightOutlined />
            </div>
            <div class="cityinfo" v-if="children">
              <div style="width:95%">
                <div v-for="(ite,ind) in children.ch" :key="ind" class="citychildren">
