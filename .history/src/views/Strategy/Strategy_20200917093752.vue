  ...
  <div class="strategyall">
    <div class="strategy">
      ...
      <div class="right">
        ...
        <!-- 推荐攻略-->
        <div style="width:100%;display:flex;align-items:center;justify-content:e;">
          <div
            style="color:orange;font-size:20px;height:55px;display:flex;align-items:center;justify-content:center;border-bottom:1.5px solid orange;"
          >推荐攻略</div>
          <div
            style="height:100%;border-bottom:1px solid red;width:50%;display:flex;align-items:center;justify-content:end;"
          >
