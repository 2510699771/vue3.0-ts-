      ...
      <div class="strategy">
        ...
        <div class="middle">
          <div style="width:33%;border:1px solid rgb(199, 199, 199);border-top:1px solid white">
            ...
            <div
              style="position:relative;display:flex;justify-content: center;align-items: center;margin-top:20px;flex-direction: column;"
            >
              <div class="item">
                <div>出发城市</div>
              ...
              <div>
                ...
                ></div>
                <div></div>
                <div style="width:20px;height:20px;border-bottom:1px solid grey;border-right:1px solid grey;"></div>
              </div>
            </div>
          </div>
          <div style="width:65%">
