...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    let data: Data = reactive<Data>({
      ...
      addomg:[{img:'http://157.122.54.189:9095/assets/images/tj01.jpg'},{img:'http://157.122.54.189:9095/assets/images/tj02.jpg'},{img:'http://157.122.54.189:9095/assets/images/tj03.jpg'},{img:''}]
      SpecialAir: [],
    });
    onMounted(() => {
      api
