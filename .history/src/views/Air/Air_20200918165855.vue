          ...
          <div style="width:33%;border:1px solid rgb(199, 199, 199);border-top:1px solid white">
            ...
            <div style="position:relative;display:flex;margin:2% 0 0 7%;flex-direction: column;">
              <div class="item">
                ...
                <a-input v-model:value="form.from" style="width:80%;margin-left:1%" />
              </div>

              <div class="item">
                <div style="white-space:nowrap">到达城市</div>
                <a-input v-model:value="form.to" style="width:80%;margin-left:1%" />
              </div>
              ...
              <div class="item1">
                <a-button type="primary" style="width:80%;margin-left:1%" @click="onSubmit">
