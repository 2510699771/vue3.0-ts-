      ...
      <div class="strategy">
        ...
        <div class="airs">
          <div
            ...
            :key="index"
            style="width:23%;border: 1px solid red;"
          >
            <div
              :style="`background:url(${item.cover}) center center no-repeat`"
              style="height:100px"
            ></div>
          </div>
        </div>
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    let data: Data = reactive<Data>({
      ...
      addomg:[{img:'http://157.122.54.189:9095/assets/images/tj01.jpg'},{img:'http://157.122.54.189:9095/assets/images/tj02.jpg'},{img:'http://157.122.54.189:9095/assets/images/tj03.jpg'},{img:'http://157.122.54.189:9095/assets/images/tj04.jpg'}]
      SpecialAir: [],
    });
    onMounted(() => {
      api
