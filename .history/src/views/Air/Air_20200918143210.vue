        ...
        <div class="middle">
          <div style="width:33%;border:1px solid rgb(199, 199, 199);border-top:1px solid white">
            ...
            <div style="display:flex;justify-content: center;align-items: center;margin-top:20px">
              <a-form
                style="width:100%;border:1px solid red;display:flex;flex-direction: column;"
                ref="ruleForm"
                :model="form"
                :rules="rules"
                labelAlign="left"
              ...
              >
                <a-form-item
                  ...
                  name="from"
                  class=""
                  style="display:flex;margin-right:0;width:100%;border:1px solid red;justify-content: center;"
                >
                  <a-input v-model:value="form.from" style="width:100%" />
                </a-form-item>
                <a-form-item ref="to" label="到达城市" name="to" style="display:flex">
                  <a-input v-model:value="form.to" />
                </a-form-item>
                <a-form-item label="出发事件" name="date1" style="display:flex">
                  <a-date-picker
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    let data: Data = reactive<Data>({
      ...
      rules: {
        from: [{ required: true, message: "验证码不能为空", trigger: "blur" }],
        to: [{ required: true, message: "验证码不能为空", trigger: "blur" }],
        date1: [
          {
            required: true,
            trigger: "change",
