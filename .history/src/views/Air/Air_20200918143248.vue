        ...
        <div class="middle">
          <div style="width:33%;border:1px solid rgb(199, 199, 199);border-top:1px solid white">
            ...
            <div style="display:flex;justify-content: center;align-items: center;margin-top:20px">
              ...
              >
                <a-form-item ref="from" label="出发城市" name="from" class="item" style>
                  <a-input v-model:value="form.from" style="width:100%" />
                </a-form-item>
                <a-form-item ref="to" label="到达城市" name="to" class="item" style="display:flex">
                  <a-input v-model:value="form.to" />
                </a-form-item>
                <a-form-item label="出发事件" name="date1"  class="item"style="display:flex">
                  <a-date-picker
