        ...
        <div class="middle">
          <div style="width:33%;border:1px solid rgb(199, 199, 199);border-top:1px solid white">
            <div style="width:100%;display:flex; ">
              <div
                style="flex:1;display:flex;justify-content: center;align-items: center;height:70px;border-top:3px solid orange"
              >
                <div class="icon">
                  <SwapRightOutlined />
                </div>
              ...
              <div
                style="flex:1;display:flex;justify-content: center;align-items: center;height:55px;background-color: rgb(212, 211, 211)"
              >
                <div class="icon">
                  <SwapOutlined />
                </div>
