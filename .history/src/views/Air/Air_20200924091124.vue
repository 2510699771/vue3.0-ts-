            ...
            <div style="position:relative;display:flex;margin:2% 0 0 7%;flex-direction: column;">
              <div class="item">
                ...
                <a-select
                  ...
                  @search="fromSearch"
                >
                  <a-select-option v-for="(item,index) in data" :key="index">{{ item.name }}</a-select-option>
                </a-select>
              </div>
              ...
              <div class="item">
                ...
                <a-select
                  ...
                  @search="handleSearch"
                >
                  <a-select-option v-for="(item,index) in data1" :key="index">{{ item.name }}</a-select-option>
                </a-select>
              </div>
        ...
        <div class="airs">
          <div class="airsconter">
            ...
            >
              ...
              <div class="ft">{{item.destCity}}-{{item.departCity}}</div>
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    ...
    //到达城市
    let handleSearch = (value: any): void => {
      if (value) {
        api
          .getcities({ name: value })
          .then((res) => {
    ...
    let change = (): void => {
      console.log(data.form.from, data.form.to);
