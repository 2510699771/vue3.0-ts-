<template>
  <div class="strategyall">
    <div class="strategy">
      ...
      <div class="right">
        <div>
          <div class="rightTop" style="margin:15px 10px 0 10px;font-size: 16px;">
          ...
          <div class="rightTop">
            <div style="font-size:14px;color: #666;">订单总价</div>
            <div style="font-size:14px;color: #666;">金额</div>
            <div style="font-size:14px;color: #666;">数量</div>
          </div>
          <div class="rightTop">
            <div>成人机票</div>
          ...
          <div class="rightTop">
            <div>应付总额：</div>
            <div>￥{{arr.base_price*domains.length+50*domains.length}}</div>
          </div>
        </div>
      </div>
    </div>
