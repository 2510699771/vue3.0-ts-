          ...
          <div>
            ...
            >
              ...
              <a-form-item
                ...
                label="验证码"
                name="age"
                style="display:flex;width:100%;border:1px solid red;justify-content: space-between;"
              >
                <a-input v-model:value="ruleForm.age" style="width:100%;border:1px solid red" />
