    ...
    <div class="strategy">
      <div class="left">
        ...
        <div>
          ...
          >
            <a-form-item required has-feedback label="姓名" name="pass" style="display:flex;width:50%">
              <a-input v-model:value="ruleForm.pass" type="password" autocomplete="off" />
            </a-form-item>
            <a-form-item has-feedback label="手机" name="checkPass" style="display:flex">
              <a-input v-model:value="ruleForm.checkPass" type="password" autocomplete="off" />
            </a-form-item>
            <a-form-item has-feedback label="验证码" name="age" style="display:flex">
