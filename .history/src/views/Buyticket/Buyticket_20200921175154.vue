  ...
  setup(props, ctx: SetupContext) {
    let data: Data = reactive<Data>({
      ...
      ruleForm: {
       ...
       rules: {
        pass: [{  required: true, message: "手机号不能为空", trigger: "blur},{pattern: RegExp(/^1[34578]\d{9}$/),message: "手机号格式错误",
            trigger: "blur",
          },],
        checkPass: [{  required: true, message: "手机号不能为空", trigger: "blur}],
        age: [{  required: true, message: "手机号不能为空", trigger: "blur}],
      },
    };
    });
