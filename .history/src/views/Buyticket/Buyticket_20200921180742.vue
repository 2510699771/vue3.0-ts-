      ...
      <div class="left">
        ...
        <div>
          ...
          >
            ...
            <a-form-item has-feedback label="手机" name="checkPass" style="display:flex;width:50%;border:1px solid red;">
              <a-input v-model:value="ruleForm.checkPass" type="password" autocomplete="off" />
            </a-form-item>
            <a-form-item has-feedback label="验证码" name="age"  style="display:flex;width:50%;border:1px solid red;">
