        ...
        <div>
          <a-form ref="dynamicValidateForm" style="width:100%;" v-bind="formItemLayoutWithOutLabel">
            ...
            >
              <div>乘机人</div>
              <div
                style="display:flex;width:100%;border:1px solid red;align-items:center;justify-content:space-between;"
              >
                <a-input v-model:value="domain.value" style="width:90%" placeholder="姓名" />
                <div style="width:10%;display:flex;justify-content:flex-between;">
                  <MinusCircleOutlined
