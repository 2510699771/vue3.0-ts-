        ...
        <div>
          <a-form ref="dynamicValidateForm" style="width:100%;" v-bind="formItemLayoutWithOutLabel">
            ...
            >
              ...
              >
                <a-input v-model:value="domain.value" style="width:70%" placeholder="姓名" />
              ...
              >
                <a-input-group>
                  <a-select v-model:value="value1">
                    <a-select-option key value="value1">身份证</a-select-option>
                    <a-select-option key value="value2">护照</a-select-option>
                  </a-select>
                  <a-input v-model:value="domain.value1" style="width:70%" placeholder="证件号码"></a-input>
                </a-input-group>
