  ...
  <div class="strategyall">
    <div class="strategy">
      <div class="left">
        ...
        <div v-for="(item,index)in arr.insurances" :key="index">
          <a-checkbox v-mode1:checked="checked" @change="onchange">{{item.type}}:￥30/份x1 最高赔付{{item.compensation}}</a-checkbox>
        </div>
      </div>
      <div></div>
    </div>
