  ...
  <div class="strategyall">
    <div class="strategy">
      <div class="left">
        ...
        <div
          style="margin-bottom:20px;height:290px;display:flex;flex-direction: column;justify-content: center;border-bottom:1px dotted  rgb(219, 219, 219)"
        >
            ...
            >
              ...
              >
                <a-input
                  ...
                  type="password"
                  style="margin-right:0px;width:125%"
                  autocomplete="off"
                />
              </a-form-item>
              ...
              <a-form-item
                ...
                label="验证码"
                name="age"
                style="display:flex;width:80%;border:1px solid red"
              >
                <a-input v-model:value="ruleForm.age" style="width:80%;border:1px solid red" />
                <div style="width:10%">
                  <a-button style="width:10%" @click="code">发送验证码</a-button>
                </div>
              </a-form-item>
              <a-form-item :wrapper-col="{ span: 14, offset: 4 }">
                <a-button type="primary" @click="info">Submit</a-button>
