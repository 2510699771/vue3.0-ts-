  ...
  <div class="strategyall">
    <div class="strategy">
      <div class="left">
        ...
        <div>
          <a-form ref="dynamicValidateForm" style="width:100%;" :model="domains" :rules="rules">
            <a-form-item
        ...
        >
          ...
          <div>
            <a-form
              ...
              :rules="rules"
            >
              <a-form-item required label="姓名" name="checkPass" style="display:flex;width:80%;">
                <a-input
              ...
              <a-form-item label="手机" name="pass" style="display:flex;width:80%;">
                <a-input v-model:value="ruleForm.pass" style="width:125%" autocomplete="off" />
              </a-form-item>
              <a-form-item ref="codd" style="display:flex" label="验证码" name="age">
      ...
      <div class="right">
        <div class="rightborder">
          <div class="rightconter">
            ...
            <div class="rightTop" style="font-size: 16px;">
              <div>
                <div style="font-size:22px;font-weight:400;">{{arr.dep_time}}</div>
                <div style="font-size:12px;color: #999;">{{arr.dst_airport_name}}</div>
              </div>
              <div style="font-size:12px;color: #999;">{{arr.plane_name}}</div>
              <div>
                <div style="font-size:22px;font-weight:400;">{{arr.arr_time}}</div>
                <div style="font-size:12px;color: #999;">{{arr.org_airport_name}}</div>
              </div>
            </div>
            <div class="rightTop">
              <div>订单总价</div>
            ...
            <div class="rightbottom">
              <div>应付总额：</div>
              <div
                style="font-size:28px;color:orange;"
              >￥{{arr.base_price*domains.length+50*domains.length}}</div>
            </div>
          </div>
        </div>
      </div>
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    ...
    let info = () => {
      shin.value!.validate().then((res: any) => { message.success(
          data.arr.base_price * data.domains.length + 50 * data.domains.length
        );});
      dynamicValidateForm.value!.validate().then((res: any) => {
