        ...
        >
          ...
          <div>
            <a-form
              ...
              :rules="rules"
            >
              <a-form-item required label="姓名" name="pass" style="display:flex;width:80%;">
                <a-input
              ...
              <a-form-item label="手机" name="checkPass" style="display:flex;width:80%;">
                <a-input v-model:value="ruleForm.checkPass" style="width:125%" autocomplete="off" />
              </a-form-item>
