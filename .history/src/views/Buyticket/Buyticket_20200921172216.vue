  ...
  <div class="strategyall">
    <div class="strategy">
      <div class="left">
        ...
        <div
          style="margin-bottom:20px;height:120px;display:flex;flex-direction: column;justify-content: center;border-bottom:1px dotted  rgb(219, 219, 219)"
        >
          <div class="title">保险</div>
          <div v-for="(item1,index1) in arr.insurances" :key="index1" class="check">
            <a-checkbox
