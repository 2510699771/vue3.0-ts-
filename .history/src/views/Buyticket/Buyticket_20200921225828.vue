          ...
          <div>
            ...
            >
              ...
              <a-form-item
                ...
                label="验证码"
                name="age"
                style="display:flex;width:60%;border:1px solid red"
              >
                <a-input v-model:value="ruleForm.age" style="width:50%" />
                <a-button style="margin-left:5px" @click="code">发送验证码</a-button>
              </a-form-item>
