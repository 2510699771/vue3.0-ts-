        ...
        <div>
          <a-form ref="dynamicValidateForm" style="width:100%;" :model="domains" :rules="rules">
            ...
            >
              ...
              >
                <a-input v-model:value="domain.value" :name="value" style="width:100%" placeholder="姓名" />
              ...
              >
                <a-input-group compact style="width:100%">
                  ...
                  <a-input :name="value1" v-model:value="domain.value1" style="width:80%" placeholder="证件号码"></a-input>
                </a-input-group>
