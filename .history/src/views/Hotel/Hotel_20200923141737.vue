    ...
    <div class="strategy">
      ...
      <div class="info">
        <div v-for="(item,index) in hotel" :key="index" class="soloinfo">
          ...
          <div style="flex:1.5;display:flex;justify-content:center;align-items: center;width:100%">
            <div v-for="(ite,ind) in item.products" :key="ind" style="width:80%;justify-content: space-between;">
              <div>{{ite.name}}</div>
              <div>{{ite.price}}</div>
            </div>
          </div>
