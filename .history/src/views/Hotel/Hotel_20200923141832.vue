    ...
    <div class="strategy">
      ...
      <div class="info">
        <div v-for="(item,index) in hotel" :key="index" class="soloinfo">
          ...
          <div style="flex:1.5;display:flex;justify-content:center;align-items: center;width:100%;  flex-direction: column;">
            <div
              v-for="(ite,ind) in item.products"
              :key="ind"
              style="width:80%;justify-content: space-between;width:100%"
            >
              <div>{{ite.name}}</div>
              <div>{{ite.price}}</div>
            </div>
