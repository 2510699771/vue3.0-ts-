  ...
  <div class="strategyall">
    <div class="strategy">
      <div style="width:100%;border:1px solid orange;display:flex">
        ...
        <a-button
          style="style="margin-left:15px"width:15%;color: rgb(208, 208, 208);display:flex;justify-content:space-between;align-items: center;font-size:14px;padding:0 10px"
        >
