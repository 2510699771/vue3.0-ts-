<template>
  ...
  <div class="strategyall">
    <div class="strategy">
      ...
      <div style="margin-top:15px;display:flex;border:1px solid red;justify-content:space-between;">
        <div style="width:59%;">
          <div class="topleft">
      ...
      <div>
        ...
        <div>
          <a-select
            ...
            @change="handleChange"
          >
            <a-select-option v-for="(item,index) in select" :key="index" :value="item.name">{{item.name}}</a-select-option>
          </a-select>
        </div>
      </div>
    </div>
