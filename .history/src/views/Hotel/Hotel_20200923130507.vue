              ...
              api
                ...
                .then((res) => {
                  ...
                  res.data.map((item) => {
                    ...
                    console.log(item.location.latitude, item.location.latitude);
                    let long = item.location.latitude;
                    let marker = new AMap.Marker({
                      position: new AMap.LngLat(lat, long), // 经纬度对象，也可以是经纬度构成的一维数组[116.39, 39.9]
                      title: item.name,
                    });
