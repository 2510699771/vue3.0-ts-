    ...
    <div class="strategy">
      ...
      <div class="info">
        <div v-for="(item,index) in hotel" :key="index" class="soloinfo">
          ...
          <div style="flex:2;margin-left">
            <div style="font-weight:400;font-size:x-large;">{{item.name}}</div>
            <div>
              {{item.alias}}
            ...
            <div>
              <a-rate v-model:value="item.stars" allow-half disabled />
              <span style="color:orange">{{item.stars}}分</span>
              <span style="margin-left:10%">{{item.num_collected}}条评论</span>
              <span style="margin-left:10%">{{item.roomCount}}篇游记</span>
            </div>
          ...
          <div style="flex:1.5;display:flex;justify-content:center;flex-direction: column;">
            <div
              v-for="(ite,ind) in item.products"
              :key="ind"
              style="width:80%;border:1px solid red;display:flex;justify-content:space-between;width:100%;margin-top:10px"
            >
              <div style="margin-left:20px">{{ite.name}}</div>
              <div style="margin-right:20px;color:orange">
                ￥{{ite.price}}起
                <RightOutlined />
              </div>
            </div>
