    ...
    <div class="strategy">
      <div style="width: 100%; display: flex">
        <a-input
          ...
          placeholder="切换城市"
        />
        <a-range-picker :placeholder=['入住日期','离店日期'] v-model:value="value1"></a-range-picker>
        style="margin-left: 15px" @change="onChange" />
        <a-button
          style="
            margin-left: 12px;
            width: 15%;
      ...
      >
        <div style="width: 59%">
          <div class="topleft">
            ...
            <div class="ares">
              <div v-for="(item, index) in ares" :key="index">
                {{ item.name }}
              </div>
            </div>
          </div>
      ...
      <div class="info">
        <div v-for="(item, index) in hotel" :key="index" class="soloinfo">
          ...
          <div style="flex: 2; margin-left: 20px">
            <div style="font-weight: 400; font-size: x-large">
              {{ item.name }}
            </div>
            <div>
              {{ item.alias }}
